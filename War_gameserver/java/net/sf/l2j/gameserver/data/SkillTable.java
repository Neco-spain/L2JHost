...
public class SkillTable {
	...
	/**
	 * Enum to hold some important references to frequently used (hardcoded) skills
	 * in core
	 */
	public enum FrequentSkill {
		LUCKY(194, 1), BLESSING_OF_PROTECTION(5182, 1),

		SEAL_OF_RULER(246, 1), BUILD_HEADQUARTERS(247, 1), STRIDER_SIEGE_ASSAULT(325, 1),

		DWARVEN_CRAFT(1321, 1), COMMON_CRAFT(1322, 1),

		HARVEST(2098, 1),

		FIREWORK(5965, 1), LARGE_FIREWORK(2025, 1), SPECIAL_TREE_RECOVERY_BONUS(2139, 1),

		ANTHARAS_JUMP(4106, 1), ANTHARAS_TAIL(4107, 1), ANTHARAS_FEAR(4108, 1), ANTHARAS_DEBUFF(4109, 1),
		ANTHARAS_MOUTH(4110, 1), ANTHARAS_BREATH(4111, 1), ANTHARAS_NORMAL_ATTACK(4112, 1),
		ANTHARAS_NORMAL_ATTACK_EX(4113, 1), ANTHARAS_SHORT_FEAR(5092, 1), ANTHARAS_METEOR(5093, 1),

		QUEEN_ANT_BRANDISH(4017, 1), QUEEN_ANT_STRIKE(4018, 1), QUEEN_ANT_SPRINKLE(4019, 1), NURSE_HEAL_1(4020, 1),
		NURSE_HEAL_2(4024, 1),

		ZAKEN_TELE(4216, 1), ZAKEN_MASS_TELE(4217, 1), ZAKEN_DRAIN(4218, 1), ZAKEN_HOLD(4219, 1),
		ZAKEN_DUAL_ATTACK(4220, 1), ZAKEN_MASS_DUAL_ATTACK(4221, 1), ZAKEN_SELF_TELE(4222, 1),
		ZAKEN_NIGHT_TO_DAY(4223, 1), ZAKEN_DAY_TO_NIGHT(4224, 1), ZAKEN_REGEN_NIGHT(4227, 1), ZAKEN_REGEN_DAY(4242, 1),

		RAID_CURSE(4215, 1), RAID_CURSE2(4515, 1), RAID_ANTI_STRIDER_SLOW(4258, 1),

		WYVERN_BREATH(4289, 1), ARENA_CP_RECOVERY(4380, 1), VARKA_KETRA_PETRIFICATION(4578, 1),
		FAKE_PETRIFICATION(4616, 1),

		THE_VICTOR_OF_WAR(5074, 1), THE_VANQUISHED_OF_WAR(5075, 1),
		ID_VISUAL_EFFECT_WARRIOR(Config.ID_VISUAL_EFFECT_WARRIOR, 1),
		ID_VISUAL_EFFECT_KNIGHTS(Config.ID_VISUAL_EFFECT_KNIGHTS, 1),
		ID_VISUAL_EFFECT_WIZARDS(Config.ID_VISUAL_EFFECT_WIZARDS, 1);
