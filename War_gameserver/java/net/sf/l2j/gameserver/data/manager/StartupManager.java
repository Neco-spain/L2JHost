       ...
       public void Classes(String command, Player player)
       {
           ...
           else
           {
               ...
               if (command.startsWith("mjlight"))
              {
                   ...
                   List<Integer> MJL = Arrays.asList(new Integer[]
                       {
                       Integer.valueOf(2395),
                       Integer.valueOf(2419),
                       Integer.valueOf(5775),
                      Integer.valueOf(5787),
                       Integer.valueOf(924),
                       Integer.valueOf(862),
                       Integer.valueOf(893),
                       Integer.valueOf(871),
               ...
               else if (command.startsWith("dc"))
               {
                   ...
                   List<Integer> MageArmorDC = Arrays.asList(new Integer[]
                       {
                       Integer.valueOf(2407),
                      Integer.valueOf(512),
                       Integer.valueOf(5767),
                       Integer.valueOf(5779),
                       Integer.valueOf(924),
                      Integer.valueOf(862),
                       Integer.valueOf(893),
                       Integer.valueOf(871),
               ...
               else if (command.startsWith("tl"))
               {
                   ...
                   List<Integer> MageArmorTL = Arrays.asList(new Integer[]
                       {
                       Integer.valueOf(2400),
                       Integer.valueOf(2405),
                       Integer.valueOf(547),
                       Integer.valueOf(5770),
                       Integer.valueOf(5782),
                       Integer.valueOf(924),
                       Integer.valueOf(862),
                       Integer.valueOf(893),
                       Integer.valueOf(871),
              ...
              else if (command.startsWith("nmh"))
               {
                   ...
                   List<Integer> NMH = Arrays.asList(new Integer[]
                      {
                       Integer.valueOf(374),
                       Integer.valueOf(2418),
                       Integer.valueOf(5771),
                       Integer.valueOf(5783),
                       Integer.valueOf(924),
                       Integer.valueOf(862),
                       Integer.valueOf(893),
                       Integer.valueOf(871),
               ...
               else
               {
                   ...
                   if (command.startsWith("majheavy"))
                   {
                       ...
                       List<Integer> NMH = Arrays.asList(new Integer[]
                           {
                           Integer.valueOf(2383),
                           Integer.valueOf(2419),
                           Integer.valueOf(5774),
                           Integer.valueOf(5786),
                           Integer.valueOf(924),
                           Integer.valueOf(862),
                           Integer.valueOf(893),
                           Integer.valueOf(871),
                   ...
                   else if (command.startsWith("som"))
                   {
                       ...
                       List<Integer> SOM = Arrays.asList(new Integer[]
                           {
                           Integer.valueOf(5643),
                           Integer.valueOf(641)
                           });
                       ItemInstance items = null;
                   ...
                   else if (command.startsWith("bran"))
                   {
                       ...
                       List<Integer> bran = Arrays.asList(new Integer[]
                           {
                           Integer.valueOf(5607)
                           });
                       ItemInstance items = null;
                   ...
                   else if (command.startsWith("dread"))
                   {
                       ...
                       List<Integer> dread = Arrays.asList(new Integer[]
                           {
                           Integer.valueOf(5633)
                           });
                       ItemInstance items = null;
                   ...
                   else if (command.startsWith("darkl"))
                   {
                      ...
                      List<Integer> darkl = Arrays.asList(new Integer[]
                           {
                           Integer.valueOf(5648),
                           Integer.valueOf(2498)
                           });
                       ItemInstance items = null;
                   ...
                   else if (command.startsWith("dragon"))
                   {
                       ...
                       List<Integer> dra = Arrays.asList(new Integer[]
                           {
                           Integer.valueOf(5644)
                           });
                       ItemInstance items = null;
                   ...
                   else if (command.startsWith("ely"))
                   {
                       ...
                       List<Integer> ely = Arrays.asList(new Integer[]
                           {
                           Integer.valueOf(5602),
                           Integer.valueOf(2498)
                           });
                       ItemInstance items = null;
                   ...
                   else if (command.startsWith("carnage"))
                   {
                      player.sendPacket(new PlaySound("ItemSound.quest_accept"));
                       ...
                       List<Integer> car = Arrays.asList(new Integer[]
                           {
                           Integer.valueOf(5609)
                           });
                      ItemInstance items = null;
                   ...
                   else if (command.startsWith("soulbow"))
                   {
                       ...
                       List<Integer> soul = Arrays.asList(new Integer[]
                           {
                           Integer.valueOf(5612)
                           });
                       ItemInstance items = null;
                   ...
                   else if (command.startsWith("bloody"))
                   {
                       ...
                       List<Integer> bloody = Arrays.asList(new Integer[]
                           {
                           Integer.valueOf(5614)
                           });
                       ItemInstance items = null;
                   ...
                   else if (command.startsWith("soulsepa"))
                   {
                       ...
                       List<Integer> soulsepa = Arrays.asList(new Integer[]
                           {
                           Integer.valueOf(5618)
                           });
                       ItemInstance items = null;
                   ...
                   else if (command.startsWith("damascus"))
                   {
                       ...
                       List<Integer> damascus = Arrays.asList(new Integer[]
                           {
                           Integer.valueOf(5706)
                           });
                       ItemInstance items = null;
                   ...
                   else if (command.startsWith("garra"))
                   {
                       ...
                       List<Integer> dragong = Arrays.asList(new Integer[]
                           {
                           Integer.valueOf(5625)
                           });
                       ItemInstance items = null;
                   ...
                   else if (command.startsWith("teleport") || command.startsWith("back_town"))
                   {
                       ...
                       player.teleportTo(Config.TELE_TO_LOCATION[0] + Rnd.get(-80, 80), Config.TELE_TO_LOCATION[1] + Rnd.get(-80, 80), Config.TELE_TO_LOCATION[2], 0);
