...
public class UserInfo extends L2GameServerPacket
{
	...
	protected final void writeImpl()
	{
		...
		writeD(_player.isDressMeEnabled() && _player.isHairSkin() && _player.getDressMeData() != null ? _player.getDressMeData().getHairAllId() : _player.getInventory().getItemObjectIdFrom(Paperdoll.HAIRALL));
		...
		writeD(_player.isDressMeEnabled() && _player.getDressMeData() != null ? _player.getDressMeData().getGlovesId() : _player.getInventory().getItemObjectIdFrom(Paperdoll.GLOVES));
		writeD(_player.isDressMeEnabled() && _player.getDressMeData() != null ? _player.getDressMeData().getChestId() : _player.getInventory().getItemObjectIdFrom(Paperdoll.CHEST));
		writeD(_player.isDressMeEnabled() && _player.getDressMeData() != null ? _player.getDressMeData().getLegsId() : _player.getInventory().getItemObjectIdFrom(Paperdoll.LEGS));
		writeD(_player.isDressMeEnabled() && _player.getDressMeData() != null ? _player.getDressMeData().getBootsId() : _player.getInventory().getItemObjectIdFrom(Paperdoll.FEET));
		writeD(_player.getInventory().getItemObjectIdFrom(Paperdoll.CLOAK));
		writeD(_player.getInventory().getItemObjectIdFrom(Paperdoll.RHAND));
		writeD(_player.isDressMeEnabled() && _player.isHairSkin() && _player.getDressMeData() != null ? _player.getDressMeData().getHairAllId() : _player.getInventory().getItemObjectIdFrom(Paperdoll.HAIR));
		writeD(_player.getInventory().getItemObjectIdFrom(Paperdoll.FACE));
		
		writeD(_player.isDressMeEnabled() && _player.isHairSkin() && _player.getDressMeData() != null ? _player.getDressMeData().getHairAllId() : _player.getInventory().getItemIdFrom(Paperdoll.HAIRALL));
		...
		writeD(_player.isDressMeEnabled() && _player.getDressMeData() != null ? _player.getDressMeData().getGlovesId() : _player.getInventory().getItemIdFrom(Paperdoll.GLOVES));
		writeD(_player.isDressMeEnabled() && _player.getDressMeData() != null ? _player.getDressMeData().getChestId() : _player.getInventory().getItemIdFrom(Paperdoll.CHEST));
		writeD(_player.isDressMeEnabled() && _player.getDressMeData() != null ? _player.getDressMeData().getLegsId() : _player.getInventory().getItemIdFrom(Paperdoll.LEGS));
		writeD(_player.isDressMeEnabled() && _player.getDressMeData() != null ? _player.getDressMeData().getBootsId() : _player.getInventory().getItemIdFrom(Paperdoll.FEET));
		writeD(_player.getInventory().getItemIdFrom(Paperdoll.CLOAK));
		writeD(_player.getInventory().getItemIdFrom(Paperdoll.RHAND));
		writeD(_player.isDressMeEnabled() && _player.isHairSkin() && _player.getDressMeData() != null ? _player.getDressMeData().getHairAllId() : _player.getInventory().getItemIdFrom(Paperdoll.HAIR));
