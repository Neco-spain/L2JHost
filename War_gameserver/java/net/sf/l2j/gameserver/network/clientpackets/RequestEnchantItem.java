		...
		synchronized (item)
		{
			...
			else
			{
				...
				else
				{
					...
					int itemCount = 1;
					ItemRecoveryManager.getInstance().isInsertItem(player.getObjectId(), item.getItemId(), item.getItemName(), item.getEnchantLevel(), item.getItemType().toString(), itemCount);
