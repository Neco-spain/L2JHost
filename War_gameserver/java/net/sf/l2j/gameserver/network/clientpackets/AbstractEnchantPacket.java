...
public abstract class AbstractEnchantPacket extends L2GameClientPacket
{
	...
	public static final class EnchantScroll
	{
		...
		public EnchantScroll(boolean wep, boolean bless, boolean crystal, boolean golden, CrystalType type)
		{
		    _isWeapon = wep;
		    _grade = type;
		    _isBlessed = bless;
	...
	static
	{
		...
		_scrolls.put(729, new EnchantScroll(true, false, false, false, CrystalType.A));
		_scrolls.put(947, new EnchantScroll(true, false, false, false, CrystalType.B));
		_scrolls.put(951, new EnchantScroll(true, false, false, false, CrystalType.C));
		_scrolls.put(955, new EnchantScroll(true, false, false, false, CrystalType.D));
		_scrolls.put(959, new EnchantScroll(true, false, false, false, CrystalType.S));
		
		// Scrolls: Enchant Armor
		_scrolls.put(730, new EnchantScroll(false, false, false, false, CrystalType.A));
		_scrolls.put(948, new EnchantScroll(false, false, false, false, CrystalType.B));
		_scrolls.put(952, new EnchantScroll(false, false, false, false, CrystalType.C));
		_scrolls.put(956, new EnchantScroll(false, false, false, false, CrystalType.D));
		_scrolls.put(960, new EnchantScroll(false, false, false, false, CrystalType.S));
		
		// Blessed Scrolls: Enchant Weapon
		_scrolls.put(6569, new EnchantScroll(true, true, false, false, CrystalType.A));
		_scrolls.put(6571, new EnchantScroll(true, true, false, false, CrystalType.B));
		_scrolls.put(6573, new EnchantScroll(true, true, false, false, CrystalType.C));
		_scrolls.put(6575, new EnchantScroll(true, true, false, false, CrystalType.D));
		_scrolls.put(6577, new EnchantScroll(true, true, false, false, CrystalType.S));
		
		// Blessed Scrolls: Enchant Armor
		_scrolls.put(6570, new EnchantScroll(false, true, false, false, CrystalType.A));
		_scrolls.put(6572, new EnchantScroll(false, true, false, false, CrystalType.B));
		_scrolls.put(6574, new EnchantScroll(false, true, false, false, CrystalType.C));
		_scrolls.put(6576, new EnchantScroll(false, true, false, false, CrystalType.D));
		_scrolls.put(6578, new EnchantScroll(false, true, false, false, CrystalType.S));
		
		// Crystal Scrolls: Enchant Weapon
		_scrolls.put(731, new EnchantScroll(true, false, true, false, CrystalType.A));
		_scrolls.put(949, new EnchantScroll(true, false, true, false, CrystalType.B));
		_scrolls.put(953, new EnchantScroll(true, false, true, false, CrystalType.C));
		_scrolls.put(957, new EnchantScroll(true, false, true, false, CrystalType.D));
		_scrolls.put(961, new EnchantScroll(true, false, true, false, CrystalType.S));
		
		// Crystal Scrolls: Enchant Armor
		_scrolls.put(732, new EnchantScroll(false, false, true, false, CrystalType.A));
		_scrolls.put(950, new EnchantScroll(false, false, true, false, CrystalType.B));
		_scrolls.put(954, new EnchantScroll(false, false, true, false, CrystalType.C));
		_scrolls.put(958, new EnchantScroll(false, false, true, false, CrystalType.D));
		_scrolls.put(962, new EnchantScroll(false, false, true, false, CrystalType.S));

		// Golden Scrolls: Enchant Weapon (Substitua pelos IDs de item reais)
		_scrolls.put(2000, new EnchantScroll(true, false, false, true, CrystalType.S));  // Weapon
		_scrolls.put(2001, new EnchantScroll(false, false, false, true, CrystalType.S));  // Armor
