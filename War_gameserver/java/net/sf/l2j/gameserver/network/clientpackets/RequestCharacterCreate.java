...
public final class RequestCharacterCreate extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		player.getMemos().set("botRange", 1300);
		player.getMemos().set("slot_0", 0);
		player.getMemos().set("slot_1", 0);
		player.getMemos().set("slot_2", 0);
		player.getMemos().set("slot_3", 0);
		player.getMemos().set("slot_4", 0);
