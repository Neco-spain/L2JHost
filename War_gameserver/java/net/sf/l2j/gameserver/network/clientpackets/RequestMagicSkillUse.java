...
public final class RequestMagicSkillUse extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		// Tournament Skills not allowed
		if (player.isInTournament() && (skill.getTargetType() == SkillTargetType.AURA || skill.getSkillType() == SkillType.CANCEL || skill.getSkillType() == SkillType.WARRIOR_BANE || skill.getSkillType() == SkillType.MAGE_BANE || skill.getSkillType() == SkillType.AGGDAMAGE || skill.getSkillType() == SkillType.RESURRECT))
		{
		...
		if (player.isInTournament() && (skill.getTargetType() == SkillTargetType.AREA || skill.getTargetType() == SkillTargetType.FRONT_AREA))
		{
			sendPacket(SystemMessage.getSystemMessage(SystemMessageId.S1_CANNOT_BE_USED).addSkillName(skill));
			player.sendPacket(ActionFailed.STATIC_PACKET);
			return;
