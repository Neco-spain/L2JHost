...
public class AdminAdmin implements IAdminCommandHandler
{
	...
	public void useAdminCommand(String command, Player player)
	{
		...
		else if (command.startsWith("admin_balanceskill"))
		{
			NpcHtmlMessage htm = new NpcHtmlMessage(0);
			htm.setFile(player.isLang() + "mods/balance/skill/main.htm");
			player.sendPacket(htm);
		}
		
		else if (command.startsWith("admin_balance"))
		{
			NpcHtmlMessage htm = new NpcHtmlMessage(0);
		...
		else if (command.startsWith("admin_capsule"))
		{
