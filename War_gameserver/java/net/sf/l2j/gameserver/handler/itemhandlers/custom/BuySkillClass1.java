...
public class BuySkillClass1 implements IItemHandler {
    ...
    public void useItem(Playable playable, ItemInstance item, boolean forceUse) {
        ...
        for (Map.Entry<Integer, Integer> skillEntry : Config.SKILLCLASS1.entrySet()) {
        ...
        player.sendPacket(new ExShowScreenMessage("Voce Adiquirou todas as Habilidades deste item!", 3000));
