...
public class WeddingManagerNpc extends Folk
{
	...
	public void onBypassFeedback(Player player, String command)
	{
		...
		else if (command.startsWith("GoToLove"))
		{
			...
			if (partner.isInTournament() || partner.isInJail() || partner.isInOlympiadMode() || partner.isInDuel() || partner.isFestivalParticipant() || (partner.isInParty() && partner.getParty().isInDimensionalRift()) || partner.isInObserverMode())
			{
